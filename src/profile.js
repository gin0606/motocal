...
class Profile extends React.Component {
  static defaultProps = function() {
    ...
    alljobs.en = Object.keys(Jobs).map(function(opt) {
      return (
        <option value={opt} key={opt}>
          {intl.translate(Jobs[opt].name, "en")}
        </option>
      );
    });
    ...
    return (
      <div className="profile">
        <p className="text-success">
          最新のアップデート情報は{" "}
          <a href="http://dev-hsimyu.hatenablog.com" target="_blank">
            {" "}
            こちら{" "}
          </a>{" "}
        </p>
        <table className="table table-sm table-bordered table-responsive">
          <tbody>
            <tr>
              <td colSpan="2">
                <strong>
                  {intl.translate("プロフィールタイトル", locale)}
                </strong>
              </td>
            </tr>
            <TextWithTooltip
              tooltip={intl.translate("ランク説明", locale)}
              id={"tooltip-rank-detail"}
            >
              <tr>
            ...
            <TextWithTooltip
              tooltip={intl.translate("ジョブ説明", locale)}
              id={"tooltip-job-detail"}
            >
              <tr>
                <th className="bg-primary">
                  {intl.translate("ジョブ", locale)}*
                  <span
                    style={{ display: "block" }}
                    className="label label-default"
                  >
                    {intl.translate("得意", locale)} [{intl.translate(
                      armTypes[Jobs[this.state.job].favArm1],
                      locale
                    )},{" "}
                    {intl.translate(
                      armTypes[Jobs[this.state.job].favArm2],
                      locale
                    )}]
                  </span>
                  <span
                  ...
                  >
                    {intl.translate(
                      jobTypes[Jobs[this.state.job].type],
                      locale
                    )}
                  ...
                  >
                    {intl.translate("攻撃ボーナス", locale)}{" "}
                    {Jobs[this.state.job].atBonus}
                  </span>
                  <span
                    style={{ display: "block" }}
                    className="label label-danger"
                  >
                    {intl.translate("HPボーナス", locale)}{" "}
                    {Jobs[this.state.job].hpBonus}
                  </span>
                  <span
                    style={{ display: "block" }}
                    className="label label-success"
                  >
                    {intl.translate("攻刃ボーナス", locale)}{" "}
                    {Jobs[this.state.job].kouzinBonus}
                  </span>
                  <span
                    style={{ display: "block" }}
                    className="label label-primary"
                  >
                    {intl.translate("守護ボーナス", locale)}{" "}
                    {Jobs[this.state.job].shugoBonus}
                  </span>
                  <span
                    style={{ display: "block" }}
                    className="label label-danger"
                ...
                <td>
                  <FormControl
                    ...
                    onChange={this.handleSelectEvent.bind(this, "job")}
                  >
                    {" "}
                    {this.props.alljobs[locale]}{" "}
                  </FormControl>
                </td>
              </tr>
            </TextWithTooltip>
            ...
            <TextWithTooltip
              tooltip={intl.translate("マスボATK説明", locale)}
            ...
            <TextWithTooltip
              tooltip={intl.translate("マスボHP説明", locale)}
            ...
            <TextWithTooltip
              tooltip={intl.translate("残HP割合説明(ジータのみ)", locale)}
            ...
            <TextWithTooltip
              tooltip={intl.translate("敵の属性説明", locale)}
              id={"tooltip-enemy-element-detail"}
            >
              <tr>
                <th className="bg-primary">
                ...
                <td>
                  <FormControl
                    componentClass="select"
                    value={this.state.enemyElement}
                    onChange={this.handleSelectEvent.bind(this, "enemyElement")}
                  >
                    {" "}
                    {selector[locale].enemyElements}{" "}
                  </FormControl>
                </td>
              </tr>
            </TextWithTooltip>
            ...
            <tr>
              <th className="bg-primary">
                {intl.translate("ゼニスHP", locale)}
              </th>
              <td>
                <FormControl
                  componentClass="select"
                  value={this.state.zenithHPBonus}
                  onChange={this.handleSelectEvent.bind(this, "zenithHPBonus")}
                >
                  {" "}
                  {selector.zenithHP}{" "}
                </FormControl>
            ...
            <TextWithTooltip
              tooltip={intl.translate("武器ゼニス説明", locale)}
              id={"tooltip-weapon-zenith-detail"}
            >
              <tr>
                <th className="bg-primary">
                  {intl.translate("武器ゼニス1", locale)}({intl.translate(
                    armTypes[Jobs[this.state.job].favArm1],
                    locale
                  )})
                </th>
                <td>
                  <FormControl
                    componentClass="select"
                    value={this.state.zenithBonus1}
                    onChange={this.handleSelectEvent.bind(this, "zenithBonus1")}
                  >
                    {" "}
                    {this.props.zenithBonuses[locale]}{" "}
                  </FormControl>
                </td>
              </tr>
            </TextWithTooltip>
            ...
            >
              <tr>
                <th className="bg-primary">
                  {intl.translate("武器ゼニス2", locale)}({intl.translate(
                    armTypes[Jobs[this.state.job].favArm2],
                    locale
                  )})
                </th>
                <td>
                  <FormControl
                    componentClass="select"
                    value={this.state.zenithBonus2}
                    onChange={this.handleSelectEvent.bind(this, "zenithBonus2")}
                  >
                    {" "}
                    {this.props.zenithBonuses[locale]}{" "}
                  </FormControl>
            ...
            <tr>
              <td colSpan="2">
                <strong>
                  {intl.translate("パーティバフタイトル", locale)}
                </strong>
            ...
            <TextWithTooltip
              tooltip={intl.translate("通常バフ説明", locale)}
                ...
                <td className="table-profile-td">
                  <InputGroup>
                    <FormControl
                      ...
                      onChange={this.handleSelectEvent.bind(this, "normalBuff")}
                    >
                      {" "}
                      {selector.buffLevel}{" "}
                    </FormControl>
            ...
            <TextWithTooltip
              tooltip={intl.translate("属性バフ説明", locale)}
            ...
            <TextWithTooltip
              tooltip={intl.translate("その他バフ説明", locale)}
                ...
                <td>
                  <InputGroup>
                    <FormControl
                      ...
                      onChange={this.handleSelectEvent.bind(this, "otherBuff")}
                    >
                      {" "}
                      {selector.buffLevel}{" "}
                    </FormControl>
            ...
            <TextWithTooltip
              tooltip={intl.translate("その他バフ2説明", locale)}
                ...
                <td>
                  <InputGroup>
                    <FormControl
                      ...
                      onChange={this.handleSelectEvent.bind(this, "otherBuff2")}
                    >
                      {" "}
                      {selector.buffLevel}{" "}
                    </FormControl>
            ...
            <TextWithTooltip
              tooltip={intl.translate("HPバフ説明", locale)}
              id={"tooltip-hpbuff-detail"}
            >
              <tr>
                <th className="bg-primary">
                  {intl.translate("HPバフ", locale)}
                </th>
                <td>
                  <InputGroup>
                    <FormControl
                      ...
                      onChange={this.handleSelectEvent.bind(this, "hpBuff")}
                    >
                      {" "}
                      {selector.buffLevel}{" "}
                    </FormControl>
            ...
            <TextWithTooltip
              tooltip={intl.translate("DAバフ説明", locale)}
            ...
            <TextWithTooltip
              tooltip={intl.translate("TAバフ説明", locale)}
            ...
            <TextWithTooltip
              tooltip={intl.translate("残HP割合", locale)}
              id={"tooltip-detail"}
            >
              <tr>
                <th className="bg-primary">
                ...
                <td>
                  <InputGroup>
                    <FormControl
                      componentClass="select"
                      value={this.state.hp}
                      onChange={this.handleSelectEvent.bind(this, "hp")}
                    >
                      {selector.hplist}
                    </FormControl>
                    <InputGroup.Addon>%</InputGroup.Addon>
            ...
            <TextWithTooltip
              tooltip={intl.translate("追加ダメージバフ説明", locale)}
            ...
            <TextWithTooltip
              tooltip={intl.translate("奥義ゲージ上昇率アップ説明", locale)}
            ...
            <TextWithTooltip
              tooltip={intl.translate("敵防御固有値説明", locale)}
              ...
              <tr>
                ...
                <td>
                  <FormControl
                    ...
                    onChange={this.handleSelectEvent.bind(this, "enemyDefense")}
                  >
                    {" "}
                    {selector[locale].enemydeftypes}{" "}
                  </FormControl>
                </td>
              </tr>
            </TextWithTooltip>
            ...
            <TextWithTooltip
              tooltip={intl.translate("ジータさん基礎DA率説明", locale)}
            ...
            <TextWithTooltip
              tooltip={intl.translate("ジータさん基礎TA率説明", locale)}
            ...
            <TextWithTooltip
              tooltip={intl.translate("ジータさん奥義倍率説明", locale)}
            ...
            >
              <tr>
                <th className="bg-primary">
                  {intl.translate("ジータさん", locale)}
                  <br />
                  {intl.translate("奥義倍率", locale)}
                </th>
                <td>
                  <FormControl
                    componentClass="select"
                    value={this.state.ougiRatio}
                    onChange={this.handleSelectEvent.bind(this, "ougiRatio")}
                  >
                    {" "}
                    {selector.ougiRatio}{" "}
                  </FormControl>
            ...
            <TextWithTooltip
              tooltip={intl.translate("確保HP説明", locale)}
              id={"tooltip-minimu-hp-detail"}
            >
              <tr>
                <th className="bg-primary">
                  {intl.translate("確保HP", locale)}
                </th>
                <td>
                  <FormControl
                    type="number"
                    min="0"
                    value={this.state.minimumHP}
                    onBlur={this.handleOnBlur}
                    onChange={this.handleEvent.bind(this, "minimumHP")}
                  />
                </td>
              </tr>
            </TextWithTooltip>
            ...
            <TextWithTooltip
              tooltip={intl.translate("ダメージ上限アップ説明", locale)}
            ...
            <TextWithTooltip
              tooltip={intl.translate("奥義ダメージ上限アップ説明", locale)}
            ...
            <TextWithTooltip
              tooltip={intl.translate("チェイン数説明", locale)}
              id={"tooltip-chain-number-detail"}
            >
              <tr>
                <th className="bg-primary">
                  {intl.translate("チェイン数", locale)}
                </th>
                <td>
                  <FormControl
                    componentClass="select"
                    value={this.state.chainNumber}
                    onChange={this.handleSelectEvent.bind(this, "chainNumber")}
                  >
                    {" "}
                    {selector.chainNumber}{" "}
                  </FormControl>
                </td>
              </tr>
            </TextWithTooltip>
