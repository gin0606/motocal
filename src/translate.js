...
var multiLangData = {
  ...
  DAバフ説明: {
    en:
      "Double Attack Buff for Party. The value will be added to Character's base double attack ratio.",
  ...
  TAバフ説明: {
    en:
      "Triple Attack Buff for Party. The value will be added to Character's base triple attack ratio.",
  ...
  追加ダメージバフ説明: {
    ...
    ja:
      "追加ダメージが発生するとしてダメージを上乗せします。予想ターン毎ダメージの算出に使用されます。"
  },
  与ダメージ上昇: {
    en: "Damage UP ",
    ja: "与ダメージ上昇"
  ...
  "残HP割合説明(ジータのみ)": {
    en:
      'Remain HP Ratio of the Player. Use "Remain HP Ratio" form in Buff for Party if you want to set the remain HP ratio of all member.',
    ja:
      'ジータさんの残りHP割合です。パーティ全体の残りHP割合を一括で指定したい場合は、"パーティ全体への効果"側で”残HP割合"を指定して下さい。'
  },
  残HP割合説明: {
    en:
      "Remain HP Ratio of all members. (If chara's HP ratio is inputted, lower value is adopted for calculation.)",
    ja:
      "パーティ全体の残りHP割合です。(キャラ個別の値が入力されている場合、より低い方を採用します)"
  },
  奥義ゲージ上昇量: {
    en: "Ougi Gage Buff",
    ja: "奥義ゲージ上昇量"
  ...
  奥義ゲージ上昇率アップ説明: {
    ...
    ja:
      "奥義ゲージ上昇量に影響します。予想ターン毎ダメージの算出に使用されます。"
  },
  奥義ダメージアップ: {
    en: "Ougi Damage UP",
    ja: "奥義ダメージUP"
  ...
  ジョブ説明: {
    en:
      'Job bonuses and Favorite arm bonuses are automatically inclueded in calculation. Select "none" if you want no bonuses and favorite arms.',
    ja:
      'ジョブごとのボーナス等は自動で反映されます。得意武器補正などを反映したくない場合"なし"を選択して下さい。'
  },
  ゼニス攻撃力: {
    en: "Zenith Park ATK ",
    ja: "ゼニス攻撃力"
  ...
  武器ゼニス説明: {
    en: "",
    ja:
      "得意武器IIのゼニス（★4以上）は、Iをすべてマスター済みという前提で各6%, 8%, 10%として計算します。"
  },
  攻撃ボーナス: {
    en: "Attack Bonus",
    ja: "攻撃ボーナス"
  ...
  チェイン数説明: {
    ...
    ja:
      "チェイン数を指定してください（チェインバーストボーナスの係数が変化します）\n チェイン数1 => 係数0.0, 2 => 0.25, 3 => 0.33.., 4 => 0.5"
  },
  ジータさんのみ: {
    en: "(Player only)",
    ja: "(ジータさんのみ)"
  ...
  天司武器注記: {
    en:
      "If you added Angel's weapon in your grid, set the sort key to that based on 'Damage'.",
    ja:
      "天司武器入りで計算する場合、優先項目をダメージベースのものに設定してください."
  },
  広告: {
    en: "Ad.",
    ja: "広告"
  ...
  "notice-20170116-1": {
    en:
      "2017/01/16: Fixed HP calculation process missed including Job HP bonus and Health Bonus.",
    ja:
      "2017/01/16: ジョブのHPボーナスと守護ボーナスを計算に入れ忘れていたのを修正"
  },
  "notice-20170116-2": {
    en:
      '2017/01/16: Fixed a bug that "Character Favorite Weapon" also affect their HP.',
  ...
  "notice-20170121-1": {
    en:
      '2017/01/21: Fixed a bug that "Inferno\'s Seconda Insignia" is not affected by Agnis.',
  ...
  "notice-20170122-1": {
    en:
      "2017/01/22: Fixed a bug that some weapon which have element changes cannot add. / Added new weapons",
    ja:
      "2017/01/22: 属性変更武器が追加できなくなっていた不具合を修正 / 武器追加"
  },
  "notice-20170122-2": {
    en:
      "2017/01/22: Fixed invalid Open Enmity-Graph call if character length > 3.",
    ja:
      "2017/01/22: キャラ数が4人以上の場合に背水グラフが開けなくなっていた不具合を修正"
  },
  "notice-20170123-1": {
  ...
  "notice-20170129-1": {
    en:
      "2017/01/29: Implemented personal buff inputs. (and tweaked character tab style.) / Additional Damage buff gets displayed in skill information.",
    ja:
      "2017/01/29: キャラ個別バフ欄の追加 (キャラ欄の見た目調整) / 追加ダメージバフがスキル情報に表示されるように修正."
  },
  "notice-20170202-1": {
  ...
  "notice-20170204-2": {
    en:
      "2017/02/04: Weapons which have element variation become displayed regardless of the filter element.",
    ja:
      "2017/02/04: 属性変更武器が、属性フィルターに関わらず表示されるようにした."
  },
  "notice-20170208-1": {
    en:
      '2017/02/08: Implemented "Enmity Graph based on real HP" / Changed input behavior, open templates when a user begins name input.',
    ja:
      "2017/02/08: 実HPベースの背水グラフ表示を実装 / 武器とキャラの名前が空欄の時に入力を開始するとテンプレートが自動的に開かれるようにした."
  },
  "notice-20170212-1": {
    en:
      "2017/02/12: Fixed a bug that cannot open enmity graph if there is only one summon setup.",
    ja:
      "2017/02/12: 召喚石組み合わせが1組のみの場合に背水グラフが開けないバグを修正."
  },
  "notice-20170212-2": {
    en: "2017/02/12: Added coco&mimi Lv150.",
    ja:
      "2017/02/12: ココミミとペルソスの最終上限解放ステータスを追加. (スキル対応はまだ)."
  },
  "notice-20170212-3": {
  ...
  "notice-20170216-1": {
    ...
    ja:
      "2017/02/16: ゼノイフリート斧とEX特大の計算を追加 / ジョブの守護ボーナスの計算タイミングがおかしいのを修正."
  },
  "notice-20170217-1": {
    en:
      "17/02/2017: Currently, there is a invalid data loading bug when you load the setup from a browser. When it happened, change an value in Profile Tab. It will fix the result.",
    ja:
      "2017/02/17: 現在、ブラウザ保存したデータ読み込み時にプロフィール欄が正しく読み込まれない場合があるようです. その場合、プロフィール欄の入力値をどこでもいいので適当に変更すると正しい計算結果になるはずです."
  },
  "notice-20170218-1": {
  ...
  "notice-20170218-2": {
    en:
      "18/02/2017: Added English Name of Romeo, Yngwei, Yuisis, Rastina and Implemented English name searching for these charas.",
    ja:
      "2017/02/18: ロミオ、イングヴェイ、ユイシス、ラスティナの連撃率更新 / 英語名表示と英語名検索を実装."
  },
  "notice-20170302-1": {
    en:
      "02/03/2017: Display chara elements and enemy's element in result tab. Do not display Exp. Critical Ratio in number when djeeta's element is Non-advantage.",
    ja:
      "2017/03/02: キャラ属性と敵属性を結果欄に表示するように変更 / 非有利の時は技巧期待値を数値で表示しないように変更"
  },
  "notice-20170305-1": {
    en:
      "05/03/2017: Disabled swipe tab switching. Modified the graph add bution.",
    ja:
      "2017/03/05: スワイプによるタブ移動を無効化. グラフ追加ボタンを元に戻した."
  },
  "notice-20170305-2": {
    en: "05/03/2017: Added new weapons.",
    ja:
      "2017/03/05: 4凸ブリューナク追加. スキル「貫きの牙」追加. ブリューナク追加時にメイン装備かどうかの切り替えができるようにした."
  },
  "notice-20170306-1": {
    en: "06/03/2017: Implemented piram's 2nd skill.",
    ja:
      "2017/03/06: 4凸ピラムのスキル「鷲王の結界」実装. 効果量はジータのみDA+13%（SLv15の時）で、SLv14以下は適当に0.5%ごと減少にしています."
  },
  "notice-20170308-1": {
  ...
  "notice-20170310-1": {
    ...
    ja:
      "2017/03/10: 天司の祝福スキルを実装. 与ダメージ上昇を計算できるようにした. (スキル情報にも表示されます)"
  },
  "notice-20170311-1": {
  ...
  "notice-20170312-2": {
    en:
      '12/03/2017: Separated "Single Attack Damage" columns and added new sort keys.',
  ...
  "notice-20170317-1": {
    en:
      "17/03/2017: Implemented Angel's blessing II. / Added Seraphim weapon (SSR) templates",
    ja:
      "2017/03/17: 天司の祝福II(与ダメージアップ20%)を実装. / 天司武器SSRを追加."
  },
  "notice-20170328-1": {
    en: "28/03/2017: Fixed problems on data loading from browser.",
    ja:
      "2017/03/28: ブラウザデータロード時に正しく読み込まれないことがあるバグを修正."
  },
  "notice-20170329-1": {
    en: "29/03/2017: Fixed bugs.",
    ja:
      "2017/03/29: 霧氷の追牙に神石効果が乗らない不具合を修正 / 天司スキルが非有利の場合でも計算されてしまう不具合を修正."
  },
  "notice-20170329-3": {
    en:
      "29/03/2017: Fixed invalid loading if the weapon or summon number is not matched their default number. / Fixed that the server save function was corrupted.",
    ja:
      "2017/03/29: 武器数と召喚石組数が変更されたデータが読み込まれた際に表示がおかしくなるバグを修正 / サーバーに保存機能が動いていなかったバグを修正."
  },
  "notice-20170331-1": {
    en:
      "31/03/2017: Fixed values of normal and magna criticals (M). / Added Elysian. / Improved buff input interfaces.",
    ja:
      "2017/03/31: 技巧(中)の効果量修正 / エリュシオン追加 / バフ入力欄の利便性向上."
  },
  "notice-20170409-1": {
    en:
      "09/04/2017: Improved An Interface of Damage Simulator. / Implemented name editing of saved grids.",
    ja:
      "2017/04/09: ダメージシミュレータのインターフェースの改善 / 保存した編成の名前を編集できるようにした."
  },
  "notice-20170410-1": {
    en:
      "10/04/2017: Added a new skill Normal Tyranny II and Implemented the additional skill selection for Four beast weapons.",
    ja:
      "2017/04/09: 通常暴君IIを追加 / 新四象武器選択時に追加スキルを追加するか選択可能に."
  },
  "notice-20170414-1": {
  ...
  "notice-20170415-1": {
    en:
      "15/04/2017: Partly added English Templates! Thanks theorycrafting guys.",
  ...
  "notice-20170516-1": {
    en:
      "16/05/2017: Fixed the invalid value of Health Bonus by Majesty skills.",
  ...
  "notice-20170531-1": {
    en:
      "31/05/2017: Fixed an invalid status of Murgles / Modified the skill amount of Andalis 4* damage limit up to 7%.",
    ja:
      "2017/05/31: ミュルグレス4凸の武器ステータスが+99のものになっていたので修正 / アンダリス4凸の上限UP効果を7%に."
  },
  "notice-20170617-1": {
  ...
  "notice-20170704-1": {
    en:
      "04/07/2017: Added new weapons. Implemented 'Non' element type. Implemented critical ratio array displaying.",
    ja:
      "2017/07/04: 武器追加. 無属性と無属性（技巧あり）を実装. 技巧倍率毎の発生確率表示を実装."
  },
  "notice-20170725-1": {
    en:
      "25/07/2017: Added new weapons. Implemented Ougi Damage Limit UP calculation. Added Primacy skill.",
    ja:
      "2017/07/25: 武器追加. 奥義上限UP計算の実装. 無双スキルと奥義上限UPと舞姫の演武の実装."
  },
  "notice-20170802-1": {
    en:
      "02/08/2017: Changed damage calculation ceiling timing to match the value shown in GBF game.",
    ja:
      "2017/08/02: ダメージ計算の切り上げタイミングの調整(ゲーム内予測ダメージと一致するようになりました)"
  },
  "notice-20170805-1": {
  ...
  "notice-20170817-1": {
    en:
      "17/08/2017: Implemented Rose weapons II. Added new charas. Implemented 'Primal' race.",
    ja:
      "2017/08/17: EX攻刃守護(中)を実装. ローズ武器2を追加. 水着キャラ追加. 種族: 星晶獣を追加."
  },
  "notice-20170819-1": {
    en:
      "19/08/2017: Fixed some character data without favorite weapons. Applied new Ougi Damage Limitation Range. Fixed stopping bug when the ChainBurst Number was changed.",
    ja:
      "2017/08/19: 得意武器が抜けていたキャラを修正. 新奥義上限を適用. チェインバースト数を弄ると計算が止まる不具合を修正."
  },
  "notice-20170907-1": {
  ...
  "notice-20171117-1": {
    en:
      "17/11/2017: Added the new skill 'Normal Celere (S)' / Added new weapons and charas.",
  ...
  "notice-20171229-1": {
    en:
      "29/12/2017: Implemented Chara Limit Bonus Calculation and Ultima (Zeal) skill.",
    ja: "2017/12/29: キャラLBの計算を実装 / オメガ激情の計算を実装."
  },
  "notice-20180102-1": {
    en: "02/01/2018: Implemented Fandango skill.",
    ja:
      "2018/01/02: 乱舞(小)の計算を実装 / ダメージ上限上昇が奥義ダメージ上限へ影響していなかった不具合を修正."
  },
  "notice-20180205-1": {
  ...
  "notice-20180311-1": {
    en:
      "11/03/2018: Implemented Magna Stamina (M), Ultima Strength, and added new magna II Weapons.",
    ja:
      "2018/03/11: 方陣渾身(中)、オメガ強壮の計算を実装 / マグナII武器テンプレート追加(スキルは未対応)."
  }
};
